...
const EXPECTED_CREATURE_COSTS_BY_DECK = {
  ...
  [DECK_ID.GREEN_RED_FRONTLINE]: { 2: 22, 4: 10, 5: 4 },
...
const EXPECTED_CREATURE_COLORS_BY_DECK = {
  ...
  [DECK_ID.GREEN_RED_FRONTLINE]: { red: 14, blue: 0, green: 22 },
...
const EXPECTED_CARD_COUNTS_BY_DECK = {
  ...
  [DECK_ID.BLUE_GREEN_INTERCEPT]: {
    ...
    [CARD_ID.LIFE_DROPLET]: 1,
    [CARD_ID.TRANSFER]: 3,
    [CARD_ID.OAKBARK_SENTINEL]: 2,
    [CARD_ID.ROOTED_ANCIENT]: 2,
    [CARD_ID.VINE_SNARE_HUNTER]: 2,
    [CARD_ID.GEODE_MINER]: 2,
    [CARD_ID.ROOT_FORT_REARGUARD]: 2,
    [CARD_ID.GREAT_TREE_GUARDIAN]: 1,
    [CARD_ID.FOREST_CAGE_BEASTMASTER]: 1,
    [CARD_ID.LEYLINE_MINING_GIANT]: 1,
  ...
  [DECK_ID.GREEN_RED_FRONTLINE]: {
    ...
    [CARD_ID.DREAMWALKING_FOREST_GIANT]: 2,
    [CARD_ID.LIFE_CYCLE]: 1,
    [CARD_ID.ABUNDANCE]: 2,
    [CARD_ID.SPARK_SWORDSMAN]: 3,
    [CARD_ID.BURNING_VANGUARD]: 2,
    [CARD_ID.FORMATION_CLEARING_MERCENARY]: 2,
